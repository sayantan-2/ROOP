...
def run():
    ...
    while run_server:
        ...
        try:
            ...
            ui.queue().launch(inbrowser=launch_browser, server_name=server_name, server_port=server_port, share=False, ssl_verify=ssl_verify, prevent_thread_lock=True, show_error=True)
